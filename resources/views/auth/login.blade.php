...
<div class="kt-grid kt-grid--ver kt-grid--root kt-page">
    <div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url({{url('assets/media/bg/bg-1.jpg')}});">
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    <div class="kt-login__logo">
                        <a href="#">
                            <img src="{{url('assets/media/logos/logo-mini-2-md.png')}}">
                        </a>
                    </div>
                    <div class="kt-login__signin">
                        ...
                        <form  method="POST" action="{{ route('login') }}" class="kt-form" >
                            ...
                            <div class="input-group">
                                <input class="form-control" type="email" placeholder="Email" name="email" autocomplete="on">
                            </div>
                            <div class="input-group">
                    ...
                    <div class="kt-login__forgot">
                        ...
                        <form class="kt-form" method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="kt-login__actions">
                                <button id="" type="submit" class="btn btn-pill kt-login__btn-primary">Request</button>
