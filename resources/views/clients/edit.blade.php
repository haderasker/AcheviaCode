                        ...
                        <form class="kt-form" id="updateForm" method="POST" action="{{url('/client-update')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8">
                                    ...
                                    <div class="kt-section">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input class="form-control" type="text" readonly
                                                           value="{{$requestData['detail']['projectCity']}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input class="form-control" type="text" readonly
                                                           value="{{$requestData['detail']['projectId']}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="kt-section">
                                        <div class="kt-section__body">
                                            <h3 class="kt-section__title kt-section__title-lg">Additional Fields :</h3>
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-3 col-sm-12">Date</label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" readonly
                                                               placeholder="Select date" id="kt_datepicker_2" name="notificationDate" />
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group timepicker">
                                                        <input class="form-control" id="kt_timepicker_2" readonly
                                                               placeholder="Select time" type="text" name="notificationTime"/>
                                                        <div class="input-group-append">
														<span class="input-group-text">
                                            ...
                                            <div class="form-group form-group-last row">
                                                ...
                                                <div class="col-9">
                                                    <div class="form-group row">
                                                        <div class="kt-radio-inline">
                                                            <label class="kt-radio">
                                                                <input type="radio" value="1" name="summery"> Replied
                                                                <span></span>
                                                            </label>
                                                            <label class="kt-radio">
                                                                <input type="radio" value="2" name="summery"> Switched
                                                                Off

                                                                <span></span>
                                                            </label>
                                                            <label class="kt-radio">
                                                                <input type="radio" value="3" name="summery"> No Answer
                                                                <span></span>
                                                            </label>
                                                            <label class="kt-radio">
